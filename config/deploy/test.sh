...
# 同步打包好的文件到服务器相应目录
WWW_DIR="www/"
TARGET_DIR="/ishanggang/apps/nazgrel_web_qa"
RELEASES_DIR="/ishanggang/apps/nazgrel_web_releases_qa"
...
# 执行回收资源sh文件
ssh -p 40022 ishanggang_dev@106.14.159.184 -C "/bin/bash -s" < ./config/releases/release.sh $TARGET_DIR $RELEASES_DIR 14
